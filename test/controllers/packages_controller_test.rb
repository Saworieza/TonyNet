...
class PackagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create package" do
    assert_difference('Package.count') do
      post packages_url, params: { package: { cost: @package.cost, name: @package.name, speed: @package.speed } }
    end
  ...
  test "should update package" do
    patch package_url(@package), params: { package: { cost: @package.cost, name: @package.name, speed: @package.speed } }
