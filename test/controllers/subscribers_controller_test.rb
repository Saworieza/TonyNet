...
class SubscribersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscriber" do
    assert_difference('Subscriber.count') do
      post subscribers_url, params: { subscriber: { apartment_id: @subscriber.apartment_id, house_id: @subscriber.house_id, name: @subscriber.name, phone: @subscriber.phone } }
    end
  ...
  test "should update subscriber" do
    patch subscriber_url(@subscriber), params: { subscriber: { apartment_id: @subscriber.apartment_id, house_id: @subscriber.house_id, name: @subscriber.name, phone: @subscriber.phone } }
